		...
		return (
			<svg className="uix-polarpad__grid" viewBox={`0 0 ${size} ${size}`}>
				<rect
					...
					height="100%"
				/>
				<path className="uix-polarpad__grid-lines uix-polarpad__grid-lines--r" d={r_path} />
				<path className="uix-polarpad__grid-lines uix-polarpad__grid-lines--t" d={t_path} />
			</svg>
		);
	}
}
